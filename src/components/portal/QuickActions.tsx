  ...
  const actions: QuickAction[] = [
    {
      ...
      icon: CreditCard,
      label: 'Pay Tuition',
      labelTh: 'ชำระค่าเรียน',
      labelZh: '缴纳学费',
      description: 'Tuition fees & invoices',
      descriptionTh: 'ค่าเล่าเรียนและใบแจ้งหนี้',
      descriptionZh: '学费及账单',
    ...
    },
    {
      ...
      descriptionTh: 'คอร์สและกิจกรรมหลังเลิกเรียน',
      descriptionZh: '课程与工作坊',
    ...
    },
    {
      ...
      labelZh: '参加夏令营',
      description: 'Holiday programs & camps',
      descriptionTh: 'ค่ายและโปรแกรมช่วงวันหยุด',
      descriptionZh: '假日营地与项目',
    ...
    },
    {
      ...
      labelTh: 'กิจกรรม',
      labelZh: '活动',
      description: 'Field trips & school events',
      descriptionTh: 'ทัศนศึกษาและกิจกรรมโรงเรียน',
      descriptionZh: '校外活动与学校活动',
    ...
    },
    {
      ...
      labelTh: 'ใบเสร็จ',
      labelZh: '收据',
      description: 'Payment records & receipts',
      descriptionTh: 'บันทึกการชำระเงินและใบเสร็จ',
      descriptionZh: '付款记录与收据',
      color: 'text-primary',
